...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Display employee corresponding to index
     */
    fun showEmployeeData(index: Int) {
        ...
        employeeInfoTextView.text = lastnames[index] + " " + firstnames[index] + " is ...." + getString(R.string.loremIpsum);

        // load and show image from resourses
        var id = 0;
    ...
    /**
     * Change employee displayed when bottom button is clicked
     */
